...
/* TODO: 1: Rename component as Snacks*
edit brand color */
const TunaAuthPageBgGradient = styled.div`
  background: linear-gradient(135deg, #174d1d 30%, rgb(148 195 85) 100%);
  width: 100vw;
  height: 100vh;
`;
